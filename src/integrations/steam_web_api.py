...
Extended endpoint methods (tags, DLC, privacy, wishlist, etc.) are
provided by the SteamAPIEndpoints base class in steam_api_endpoints.py.
"""
...
from src.integrations.steam_api_endpoints import SteamAPIEndpoints
