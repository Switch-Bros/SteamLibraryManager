...
class CentralWidgetBuilder:
    ...
    def build(self) -> Dict[str, Any]:
        ...
        # noinspection PyUnresolvedReferences
        tree.selection_changed.connect(self.mw._on_games_selected)
        # noinspection PyUnresolvedReferences
        tree.games_dropped.connect(self.mw._on_games_dropped)
        ...
        details_widget = GameDetailsWidget()
        # noinspection PyUnresolvedReferences
        details_widget.category_changed.connect(self.mw._on_category_changed_from_details)
        # noinspection PyUnresolvedReferences
