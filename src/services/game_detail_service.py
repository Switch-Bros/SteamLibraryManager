...
store data, reviews, ProtonDB ratings, Steam Deck status, and news from
the core game management logic.
"""
...
class GameDetailService:
    ...
    def fetch_game_details(self, app_id: str) -> bool:
        ...
        This method fetches store data, review stats, ProtonDB ratings,
        Steam Deck status, and last update info. Results are cached locally.
