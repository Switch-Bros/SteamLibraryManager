...
-- ============================================================================
-- EXTERNAL GAMES (v7: Non-Steam game shortcuts)
-- ============================================================================

CREATE TABLE IF NOT EXISTS external_games (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    steam_shortcut_id INTEGER,
    platform TEXT NOT NULL,  -- Epic, GOG, Lutris, Bottles, Flatpak, Heroic, EA, Ubisoft
...
-- ============================================================================
-- v8: USER GAME STATUS (play status, priority, personal rating)
-- ============================================================================

CREATE TABLE IF NOT EXISTS user_game_status (
    app_id INTEGER PRIMARY KEY,
    status TEXT DEFAULT 'unplayed',  -- unplayed, playing, completed, abandoned, backlog, on_hold
    priority INTEGER DEFAULT 0,  -- 0=none, 1-5 scale
    personal_rating INTEGER,  -- 1-100 user rating
...
-- ============================================================================
-- v8: AGE RATINGS (multi-system: PEGI, ESRB, USK, CERO, etc.)
-- ============================================================================

CREATE TABLE IF NOT EXISTS age_ratings (
    app_id INTEGER NOT NULL,
    rating_system TEXT NOT NULL,  -- PEGI, ESRB, USK, CERO, etc.
    rating_value TEXT NOT NULL,  -- e.g. "16", "M", "12", "C"
    descriptors TEXT DEFAULT '',  -- comma-separated content descriptors
...
CREATE TABLE IF NOT EXISTS purchase_history (
    ...
    purchase_source TEXT,  -- steam, humble, fanatical, gog, gift, etc.
    bundle_name TEXT,
    notes TEXT,
    FOREIGN KEY (app_id) REFERENCES games(app_id) ON DELETE CASCADE
);
...
-- ============================================================================
-- v8: USER TAGS (custom user-defined tags, separate from Steam tags)
-- ============================================================================
...
-- ============================================================================
-- v8: USER LISTS (ordered game lists)
-- ============================================================================
...
-- ============================================================================
-- v8: PLAYTIME SNAPSHOTS (daily playtime deltas for trend analysis)
-- ============================================================================

CREATE TABLE IF NOT EXISTS playtime_snapshots (
    app_id INTEGER NOT NULL,
    snapshot_date INTEGER NOT NULL,  -- UNIX timestamp of day start
    playtime_minutes INTEGER NOT NULL,  -- cumulative playtime at snapshot
    playtime_delta INTEGER DEFAULT 0,  -- minutes played since last snapshot
