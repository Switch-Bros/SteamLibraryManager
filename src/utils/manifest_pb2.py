...
_PAYLOAD_FILEMAPPING_CHUNKDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="sha",
            full_name="Payload.FileMapping.ChunkData.sha",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="crc",
            full_name="Payload.FileMapping.ChunkData.crc",
            index=1,
            number=2,
            type=7,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="offset",
            full_name="Payload.FileMapping.ChunkData.offset",
            index=2,
            number=3,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="cb_original",
            full_name="Payload.FileMapping.ChunkData.cb_original",
            index=3,
            number=4,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="cb_compressed",
            full_name="Payload.FileMapping.ChunkData.cb_compressed",
            index=4,
            number=5,
            type=13,
            cpp_type=3,
...
_PAYLOAD_FILEMAPPING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="filename",
            full_name="Payload.FileMapping.filename",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="size",
            full_name="Payload.FileMapping.size",
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="flags",
            full_name="Payload.FileMapping.flags",
            index=2,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="sha_filename",
            full_name="Payload.FileMapping.sha_filename",
            index=3,
            number=4,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="sha_content",
            full_name="Payload.FileMapping.sha_content",
            index=4,
            number=5,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="chunks",
            full_name="Payload.FileMapping.chunks",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _PAYLOAD_FILEMAPPING_CHUNKDATA,
    ],
    enum_types=[],
    options=None,
    is_extendable=False,
...
_METADATA = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="gid_manifest",
            full_name="Metadata.gid_manifest",
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="creation_time",
            full_name="Metadata.creation_time",
            index=2,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="Metadata.filenames_encrypted",
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="Metadata.cb_disk_original",
            index=4,
            number=5,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="Metadata.cb_disk_compressed",
            index=5,
            number=6,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="unique_chunks",
            full_name="Metadata.unique_chunks",
            index=6,
            number=7,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="crc_encrypted",
            full_name="Metadata.crc_encrypted",
            index=7,
            number=8,
            type=13,
            cpp_type=3,
        ...
        FileMapping=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ChunkData=_reflection.GeneratedProtocolMessageType(
                    "ChunkData",
                    (_message.Message,),
                    dict(DESCRIPTOR=_PAYLOAD_FILEMAPPING_CHUNKDATA, __module__="manifest_pb2"),
                ),
...
Metadata = _reflection.GeneratedProtocolMessageType(
    "Metadata", (_message.Message,), dict(DESCRIPTOR=_METADATA, __module__="manifest_pb2")
)
_sym_db.RegisterMessage(Metadata)

Signature = _reflection.GeneratedProtocolMessageType(
    "Signature", (_message.Message,), dict(DESCRIPTOR=_SIGNATURE, __module__="manifest_pb2")
)
