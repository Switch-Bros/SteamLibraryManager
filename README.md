...
[![Tests](https://img.shields.io/badge/Tests-1174%20passed-FDE100?style=plastic&labelColor=000000)](https://github.com/Switch-Bros/SteamLibraryManager)
...
|-------|--------|-------------|
| ~~Phase 0–4~~ | ✅ Done | Foundation, Performance, Cloud Sync, Architecture, Depressurizer Parity |
| **Phase 5** | 🔄 In Progress | Smart Collections, HLTB, ProtonDB |
| Phase 6 | 📋 Planned | Steam API Extensions, Unique Features |
| Phase 7 | 📋 Planned | Final Hardening & Packaging |
