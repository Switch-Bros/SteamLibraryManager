...
_DE: dict[str, str] = {
    "date.locale_id": "de",
    "date.months_short.jan": "Jan",  "date.months_short.feb": "Feb",
    "date.months_short.mar": "Mrz",  "date.months_short.apr": "Apr",
    "date.months_short.may": "Mai",  "date.months_short.jun": "Jun",
    "date.months_short.jul": "Jul",  "date.months_short.aug": "Aug",
    "date.months_short.sep": "Sep",  "date.months_short.oct": "Okt",
    "date.months_short.nov": "Nov",  "date.months_short.dec": "Dez",
}

_EN: dict[str, str] = {
    "date.locale_id": "en",
    "date.months_short.jan": "Jan",  "date.months_short.feb": "Feb",
    "date.months_short.mar": "Mar",  "date.months_short.apr": "Apr",
    "date.months_short.may": "May",  "date.months_short.jun": "Jun",
    "date.months_short.jul": "Jul",  "date.months_short.aug": "Aug",
    "date.months_short.sep": "Sep",  "date.months_short.oct": "Oct",
    "date.months_short.nov": "Nov",  "date.months_short.dec": "Dec",
}
