...
class TestFormatDE:
    ...
    @patch("steam_library_manager.utils.i18n.t", side_effect=_t_de)
...
class TestFormatEN:
    ...
    @patch("steam_library_manager.utils.i18n.t", side_effect=_t_en)
...
class TestFallback:
    ...
    @patch("steam_library_manager.utils.i18n.t", side_effect=RuntimeError("boom"))
...
class TestParse:
    ...
    def test_european_format(self):
        ...
        from steam_library_manager.utils.date_utils import parse_date_to_timestamp
...
class TestRoundTrip:
    ...
    def test_month_preserved_de(self, _mock_t, input_date: str, expected_month: str):
        ...
        from steam_library_manager.utils.date_utils import parse_date_to_timestamp, format_timestamp_to_date
