...
SERVICE_MODULES: list[str] = [
    ...
    "steam_library_manager.services.cloud_sync",
    "steam_library_manager.services.cloud_sync.provider",
...
UI_MODULES: list[str] = [
    ...
    "steam_library_manager.ui.dialogs.cloud_sync_dialog",
    "steam_library_manager.ui.dialogs.cloud_sync_settings",
